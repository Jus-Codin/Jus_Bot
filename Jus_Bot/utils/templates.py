...
def embed_template(bot: JusBot, author: discord.User=None, **options) -> discord.Embed:
...
def error_template(bot: JusBot, author: discord.User=None, err_type=None, **options) -> discord.Embed:
  global error_msg
